      ...
      <div class="login-card-v2">
        ...
        <form class="login-form-v2">
          ...
          <div class="input-group-v2">
            ...
            <input type="password" id="passwordV2" placeholder="password123" required />
          </div>
        ...
        <div class="content-body-v2">
            ...
            <div class="alert-header-v2">
              <div class="alert-title-group-v2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <circle cx="12" cy="12" r="10" stroke="#FB2C36" stroke-width="2"/>
                  <path d="M12 8V12" stroke="#FB2C36" stroke-width="2" stroke-linecap="round"/>
                  <path d="M12 16H12.01" stroke="#FB2C36" stroke-width="2" stroke-linecap="round"/>
                </svg>
                <div>
                  <h3 class="alert-title-v2">긴급 감염 알림</h3>
                  <p class="alert-subtitle-v2">실시간 감염균 감지 및 격리 조치 필요</p>
                </div>
              </div>
            ...
            <div class="alert-cards-v2">
              <div class="alert-card-v2 urgent">
                <div class="alert-card-header-v2">
                  ...
                  <div class="infection-info-v2">
                    ...
                    <div class="infection-name-v2">VRE (Vancomycin-resistant Enterococcus)</div>
                  ...
                  <div class="action-info-v2">
                    ...
                    <div class="action-buttons-v2">
                      ...
                      <button class="btn-action-v2 secondary">상세 보기</button>
                    </div>
                  </div>
            </div>
          </div>
              ...
              <div class="alert-card-v2 urgent">
                <div class="alert-card-header-v2">
                  ...
                  <div class="infection-info-v2">
                    <div class="infection-label-v2">감염균</div>
                    <div class="infection-name-v2">MRSA (Methicillin-resistant Staphylococcus aureus)</div>
                    <div class="test-type-label-v2">검사 종류</div>
          ...
          <div class="stats-section-v2">
            <div class="stat-card-v2">
              ...
              <div class="stat-footer-v2">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                  <path d="M5 2.5L7.5 5L5 7.5" stroke="#00C950" stroke-width="0.8"/>
            ...
            <div class="stat-card-v2 urgent-stat">
              ...
              <div class="stat-footer-v2">
                <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
                  <circle cx="5.5" cy="5.5" r="4.5" stroke="#FB2C36" stroke-width="0.9"/>
                  <path d="M5.5 3V5.5" stroke="#FB2C36" stroke-width="0.9" stroke-linecap="round"/>
                  <path d="M5.5 7H5.5" stroke="#FB2C36" stroke-width="0.9" stroke-linecap="round"/>
                </svg>
                <span>즉시 대응 필요</span>
              </div>
              </div>
            ...
            <div class="stat-card-v2">
              ...
              <div class="stat-footer-v2">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
                  <path d="M4.5 2.73L6.23 4.46L4.5 6.19" stroke="#00C950" stroke-width="0.78"/>
            ...
            <div class="stat-card-v2">
              ...
              <div class="stat-footer-v2">
                <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
                  <path d="M5.5 2.7L6.8 4.5L5.5 6.3" stroke="#2B7FFF" stroke-width="0.9"/>
              ...
              <div class="activity-header-v2">
                <div class="activity-title-group-v2">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M1.67 1.67H8.33V8.33H1.67V1.67Z" stroke="#2B7FFF" stroke-width="1.67"/>
                    <path d="M11.67 1.67H18.33V8.33H11.67V1.67Z" stroke="#2B7FFF" stroke-width="1.67"/>
                    <path d="M1.67 11.67H8.33V18.33H1.67V11.67Z" stroke="#2B7FFF" stroke-width="1.67"/>
                    <path d="M11.67 11.67H18.33V18.33H11.67V11.67Z" stroke="#2B7FFF" stroke-width="1.67"/>
                  </svg>
                ...
                <div class="activity-item-v2">
                  <div class="activity-item-content-v2">
                    <div class="activity-patient-v2">
                      ...
                      <div class="activity-patient-id-v2">20241122H100002</div>
                    </div>
                ...
                <div class="activity-item-v2">
                  <div class="activity-item-content-v2">
                    <div class="activity-patient-v2">
                      ...
                      <div class="activity-patient-id-v2">20241122G100002</div>
              </div>
                ...
                <div class="activity-item-v2">
                  <div class="activity-item-content-v2">
                    <div class="activity-patient-v2">
                      ...
                      <div class="activity-patient-id-v2">20241122A100002</div>
      </div>
                ...
                <div class="activity-item-v2">
                  <div class="activity-item-content-v2">
                    <div class="activity-patient-v2">
                      ...
                      <div class="activity-patient-id-v2">20241122H100003</div>
                    </div>
                ...
                <div class="activity-item-v2">
                  <div class="activity-item-content-v2">
                    <div class="activity-patient-v2">
                      ...
                      <div class="activity-patient-id-v2">20241122G100003</div>
            </div>
            ...
            <div class="quick-actions-card-v2">
              ...
              <div class="quick-actions-list-v2">
                <button class="quick-action-btn-v2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M1.33 1.33H10.67V10.67H1.33V1.33Z" stroke="#0A0A0A" stroke-width="1.33"/>
                    <path d="M10.67 2.09L14.67 6.09L10.67 10.09" stroke="#0A0A0A" stroke-width="1.33"/>
                    <path d="M2.09 10.67H14.67" stroke="#0A0A0A" stroke-width="1.33"/>
                  </svg>
                ...
                <button class="quick-action-btn-v2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M1.33 1.33H13.33V13.33H1.33V1.33Z" stroke="#0A0A0A" stroke-width="1.33"/>
                    <path d="M8 5.33V10.67" stroke="#0A0A0A" stroke-width="1.33"/>
                    <path d="M5.33 8H10.67" stroke="#0A0A0A" stroke-width="1.33"/>
                  </svg>
                  <span>검체 접수 현황</span>
          </button>
                ...
                <button class="quick-action-btn-v2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <circle cx="8" cy="8" r="6.67" stroke="#0A0A0A" stroke-width="1.33"/>
                    <path d="M8 4.67V8" stroke="#0A0A0A" stroke-width="1.33" stroke-linecap="round"/>
                    <path d="M8 11.33H8.01" stroke="#0A0A0A" stroke-width="1.33" stroke-linecap="round"/>
                  </svg>
                ...
                <button class="quick-action-btn-v2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M2 8L6 4L14 12" stroke="#0A0A0A" stroke-width="1.33" stroke-linecap="round"/>
                    <path d="M8 4L14 10" stroke="#0A0A0A" stroke-width="1.33" stroke-linecap="round"/>
                  </svg>
                ...
                <button class="quick-action-btn-v2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <path d="M4 10L6 6L8 8L12 4" stroke="#0A0A0A" stroke-width="1.33" stroke-linecap="round"/>
                  </svg>
                  <span>TAT 통계 보기</span>
        </button>
              </div>
...
const ProfilePage = () => `
  <div class="page profile-page-v2">
    <div class="dashboard-container-v2">
      ...
      <div class="main-content-v2">
        <div class="content-header-v2">
          <button class="tab-button-v2">대시보드</button>
        ...
        <div class="content-body-v2">
          <div class="page-header-v2">
            <div>
              ...
              <p class="page-subtitle-v2">사용자 정보를 설정할 수 있습니다.</p>
            </div>
          </div>
              ...
              <div class="profile-avatar-wrapper-v2">
                <div class="profile-avatar-v2">
                  <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                    ...
                    <path d="M32 20C36.4183 20 40 23.5817 40 28C40 32.4183 36.4183 36 32 36C27.5817 36 24 32.4183 24 28C24 23.5817 27.5817 20 32 20Z" fill="#155dfc"/>
                    <path d="M20 44C20 37.3726 25.3726 32 32 32C38.6274 32 44 37.3726 44 44V48H20V44Z" fill="#155dfc"/>
                  </svg>
                </div>
                <button class="profile-avatar-edit-v2">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M14.1667 2.5C14.4417 2.225 14.8083 2.08333 15.1917 2.08333C15.575 2.08333 15.9417 2.225 16.2167 2.5L17.5 3.78333C17.775 4.05833 17.9167 4.425 17.9167 4.80833C17.9167 5.19167 17.775 5.55833 17.5 5.83333L9.16667 14.1667L5.83333 15L6.66667 11.6667L14.1667 4.16667L14.1667 2.5Z" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </button>
              </div>
              <div class="profile-header-text-v2">
                <h3 class="profile-header-title-v2">프로필 설정</h3>
                <p class="profile-header-subtitle-v2">계정 정보를 관리하고 업데이트하세요</p>
              </div>
          </div>
            ...
            <div class="profile-form-v2">
              <div class="form-section-v2">
                ...
                <div class="form-group-v2">
                  ...
                  <input type="text" class="search-input-v2" value="김의사" placeholder="이름을 입력하세요" />
                </div>
                ...
                <div class="form-group-v2">
                  ...
                  <input type="text" class="search-input-v2" value="의사" placeholder="직책을 입력하세요" />
                </div>
              </div>
              
              <div class="info-box-v2">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <circle cx="10" cy="10" r="8.33" stroke="#155dfc" stroke-width="1.67"/>
                  <path d="M10 6.67V10" stroke="#155dfc" stroke-width="1.67" stroke-linecap="round"/>
                  <path d="M10 13.33H10.01" stroke="#155dfc" stroke-width="1.67" stroke-linecap="round"/>
                </svg>
                <span>입력한 정보는 시스템 내에서 사용자를 식별하는 데 사용됩니다.</span>
              </div>
              ...
              <div class="profile-actions-v2">
                ...
                <button class="btn-save-v2">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M16.67 2.5H3.33C2.6 2.5 2 3.1 2 3.83V16.17C2 16.9 2.6 17.5 3.33 17.5H16.67C17.4 17.5 18 16.9 18 16.17V3.83C18 3.1 17.4 2.5 16.67 2.5Z" stroke="white" stroke-width="1.67"/>
                    <path d="M5.83 10L8.33 12.5L14.17 6.67" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  <span>저장</span>
                </button>
              </div>
